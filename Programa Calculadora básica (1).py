...
e_texto.grid(row = 0, column = 0, columnspan = 4, padx= 5, pady= 5) #Row significa fila
...
boton_igual = Button(ventana, text = "=", width = 5, height = 2, command = lambda: operacion_aritmetica())
